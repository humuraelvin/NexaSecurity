...
app.include_router(scan_router, prefix=f"{settings.API_V1_STR}/scans", tags=["Scans"])
app.include_router(pentest_router, prefix=f"{settings.API_V1_STR}/pentests", tags=["Penetration Tests"])
# Temporarily disabled
app.include_router(vulnerability_router, prefix=f"{settings.API_V1_STR}/vulnerabilities", tags=["Vulnerabilities"])
app.include_router(report_router, prefix=f"{settings.API_V1_STR}/reports", tags=["Reports"])
app.include_router(dashboard_router, prefix=f"{settings.API_V1_STR}/dashboard", tags=["Dashboard"])
app.include_router(api_key_router, prefix=f"{settings.API_V1_STR}/api-keys", tags=["API Keys"])
